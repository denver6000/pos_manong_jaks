...
//        viewmodel = new ViewModelProvider(requireActivity()).get(BranchFragmentViewmodel.class);
...
//            viewmodel.saveSelectionToBranchList(adapter.getSelectedItems(), new OnUpdateUI<Void>() {
//                @Override
